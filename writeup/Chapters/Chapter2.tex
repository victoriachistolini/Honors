...
\noindent  If we look at the patterns of the covariate combinations that make up the models in figure 2.8 and figure 2.9, we can see some interesting patterns. 
\begin{figure} [!ht]
